...
public partial class AddRepositoryCloudSyncQueue : Migration
{
    ...
    {
        migrationBuilder.DropTable(name: "RepositorySyncQueueItems");

        migrationBuilder.DropIndex(
            name: "IX_Repositories_CloudLastSyncedAt_CloudLastRemoteSnapshotId",
            table: "Repositories");

        migrationBuilder.DropColumn(name: "SyncConflictStrategy", table: "Repositories");
        migrationBuilder.DropColumn(name: "SyncRetryMaxAttempts", table: "Repositories");
        migrationBuilder.DropColumn(name: "SyncRetryBaseDelaySeconds", table: "Repositories");
        migrationBuilder.DropColumn(name: "CloudLastSyncedAt", table: "Repositories");
        migrationBuilder.DropColumn(name: "CloudLastLocalSnapshotId", table: "Repositories");
        migrationBuilder.DropColumn(name: "CloudLastRemoteSnapshotId", table: "Repositories");
        migrationBuilder.DropColumn(name: "CloudSyncLastStatus", table: "Repositories");
        migrationBuilder.DropColumn(name: "CloudSyncLastError", table: "Repositories");
    }
}
